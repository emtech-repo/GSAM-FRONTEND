...
export class SharedService {
  ...
  readonly AssignCaseUrl = 'http://192.168.91.128:5260/api/Case/AssignCase';
  readonly ActiveUrl = 'http://192.168.91.128:5260/api/Case/ActiveCases';
  readonly ClosedUrl = 'http://192.168.91.128:5260/api/Case/ClosedCases';
  readonly recoveryUrl = 'http://192.168.88.33:5260/api/Recover/CaseRecover';
  readonly restructureUrl = 'http://192.168.91.128:5260/api/Restructure/CaseRestructure';
  readonly refinanceUrl = 'http://192.168.91.128:5260/api/Refinance/Refinance';
  readonly approvecaseUrl = 'http://192.168.91.128:5260/api/Case/ApproveCase';
  readonly approveRestructuredUrl = 'http://192.168.91.128:5260/api/Restructure/ApproveRestructureCase';
  ...
  readonly resetUrl = 'http://192.168.91.128:5260/api/Auth/ChangePassword';
  readonly forgotUrl = 'http://192.168.91.128:5260/api/Auth/ForgotPassword';
  private  changeUrl = ' http://192.168.91.128:5260/api/Auth/ResetPassword';
  ...
  sendResetEmail(payload: { email: string, ClientUri: string }) {
